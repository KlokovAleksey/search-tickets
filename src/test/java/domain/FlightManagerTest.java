...
class FlightManagerTest {
    ...
    private Flight flight3 = new Flight(3, 600, "LED", "GOJ", 160);
    ...
    public void shouldOneSortFlight() {
        Flight[] actual = manager.findAll("FRU", "KUF", new TicketByPriceAscComparator());
    ...
    public void shouldNotExistFlight() {
        Flight[] actual = manager.findAll("LED", "FRU", new TicketByPriceAscComparator());
